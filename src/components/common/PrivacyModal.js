...
function PrivacyModal() {
  ...
  const privacyPolicyContent = `
    ...
    회사는 개인정보를 수집 및 이용 목적이 달성된 후에는 관련 법령에 따라 개인정보를 안전하게 파기합니다. 회원가입 시 수집한 개인정보는 회원 탈퇴 시까지 보유하며, 상품 주문 시 수집한 개인정보는 주문 완료 후 5년간 보관 후 파기합니다.
  ...
  const termsOfServiceContent = `
    ...
    1.	회사는 다음의 사유가 발생할 경우 서비스 이용을 제한하거나 중지할 수 있습니다:
    -	본 약관을 위반한 경우
